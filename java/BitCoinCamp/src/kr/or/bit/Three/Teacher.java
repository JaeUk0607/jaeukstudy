...
public class Teacher extends Member{
    ...
    */
    ...
    public void lectureChecking() {
        /*
        4. 강좌를 선택하면 강좌의 자세한 정보(강좌번호, 강좌이름, 선생님이름, 수강가능인원, 시작날짜, 종료날짜, 강좌시작시간, 강좌종료시간)를 보여준다.*/
        
        ///////////// entrySet()을 사용    ///////////////
        // map에 정의된 key값과 value값 다 가져온다
    ...
    public void lectureDelete() {
        ...
        //     LectureList key 값은 Lecture 폴더의 강좌파일
        //     key값을 통해 파일 경로에 key값과 동일한 파일을 찾아서 삭제
