...
public class Ex08_Calendar {
	...
	public static void main(String[] args) {
		...
		System.out.println("이달의 몇쨰 주 : "+cal.get(Calendar.WEEK_OF_MONTH) );
		System.out.println("월의 몇일 주 : "+cal.get(Calendar.DAY_OF_MONTH) );
		System.out.println("주의 몇번 쨰 : "+cal.get(Calendar.DAY_OF_WEEK) );
		...
		//웹사이트 (교육 시스템)
		//150분 (페이지) >> 120페이지 날짜 정보를 가지고 있다(서버쪽 시간)
		//2018년02월12일 >> 변경 >> 2018-02-12
