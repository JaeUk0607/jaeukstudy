...
public class Ex11_AWT_Frame {
	...
	public static void main(String[] args) {
		...
		btn.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				System.out.println("인터페이스를 익명타입으로 직접 구현");
