...
//기존 : Model2 기반의 MVC 패턴 : JDBC API 사용 (Connection , Statement ,PrepareStatment, ResultSet..)
...
public class MemberDAOImpl implements MemberDAO{
	...
	*/
	...
	public boolean memberCheck(String id, String pwd) throws SQLException {
		...
		/*
		 this.jdbctemplate.queryForList(sql,params) return List<> 게시판 전체 조회, 회원 목록 조회
		 * 
		 */
