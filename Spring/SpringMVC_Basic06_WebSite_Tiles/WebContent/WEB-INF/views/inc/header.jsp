  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="fileupload.htm" target="contents">fileupload</a></li>
            <li><a href="dragndrop.htm" target="contents">Drag&Drop</a></li>
            <li><a href="mousehover.htm" target="contents">MouseHover</a></li>
            <li><a href="giffile.htm" target="contents">GIFfile</a></li>
          </ul>
        </li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="introduce.html" target="contents">Introduce</a></li>
        <li><a href="about.html" target="contents">About</a></li>
        <li><a href="boot_Theme_final/index.html" target="_blank">go to BS Template</a></li>
      </ul>
    </div>
  </div>
</nav>