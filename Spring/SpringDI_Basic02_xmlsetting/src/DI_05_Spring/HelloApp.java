...
public class HelloApp {
	...
	public static void main(String[] args) {
		...
		//KEY POINT : 컨테이너가 구성되고 xml read 해서 객체를 생성 조립
		...
		System.out.println("before : mybean객체" + mybean);
		
		System.out.println("before : mybean2객체");
		MyBean mybean2 = context.getBean("mybean",MyBean.class);
		System.out.println("before : mybean2객체" + mybean2);
		
		//////////////////////////////////////////////////////////////
		System.out.println("before : mybean3객체");
		MyBean mybean3 = context.getBean("mybean2",MyBean.class);
		System.out.println("before : mybean3객체" + mybean3);
