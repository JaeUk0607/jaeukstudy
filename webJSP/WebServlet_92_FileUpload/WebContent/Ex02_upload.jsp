...
<%
    ...
    //cos.jar 파일에서 제공하느 MultipartRequest 객체 사용
    int size = 10*1024*1024; //10M  네이버 계산기
    String name="";
    String title="";
    String filename1="";
    String filename2="";
    ...
    String hid = multi.getParameter("hid"); //hidden
    ...
    */
    ...
    orifilename1 = multi.getOriginalFileName(file1); //원 이름 : a.jpg
