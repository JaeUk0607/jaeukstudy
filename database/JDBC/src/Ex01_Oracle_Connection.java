...
/*
 JDBC
 1. Java 를 통해서 Oracle 연결하고 CRUD 작업
 2. 어떠한 DB 소프트웨어 사용 결정 (Oracle , mysql, ms-sql)
 2.1 제품에 맞는 드라이버필요(각 젠더 사이트에서 다운로드 받아서 사용)
 ...
 4.2 개발자 interface 를 통해서 작업 ( 궁금증 : why interface 일까? hint java 뿐만 아니라 다양한 언어 사용)
 
 5. DB연결 -> 명령 -> 처리 -> 자원해제
 5.1 명령 (CRUD) : select, insert, update, delete
 5.2 처리 : select 화면 출력할꺼야 아니야 나느 확인만..........................
 5.3 자원해제 (성능)
